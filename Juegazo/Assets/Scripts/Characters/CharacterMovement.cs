...
public class CharacterMovement : MonoBehaviour
{
    ...
    void Update()
    {
        _myRigidBody.velocity = new Vector2(_movementSpeed * m_movementDirection.x, _myRigidBody.velocity.y); //usar rigidbody para mover a los personajes(+eficiente, no vibra al chocar)
